...
export class AccountPage {
	...
	shareApp() {
		if (this.platform.is('android'))
			this.SocialSharing.share('Download our app right now and get 50% on first buy!', 'Printable Idea', null, new Static(this.config).transform('modern_share_rate_android'));
