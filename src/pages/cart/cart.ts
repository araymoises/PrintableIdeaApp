...
export class CartPage {
	...
	getData() {
		...
		let coupon = this.alertCtrl.create({
			...
			message: "Remember, you can use this coupon to get 30% off!",
			...
			buttons: [
				...
				},
				{
					text: "Use",
					handler: () => {
						this.couponCode = "1stbuy30";
						let couponAccepted = this.alertCtrl.create({
							title: "Congratulations!",
							message: "Now, you can continue with your buy.",
							cssClass: 'alert-signout',
							buttons: [
								{
									text: "Ok",
